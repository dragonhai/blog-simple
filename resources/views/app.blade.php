...
<html lang="en">
	...
	<body>
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="{{ url('/') }}">Blog Simple</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						{!! Form::open(['url' => '/search', 'method'=>'GET', 'class'=>'form navbar-form searchform']) !!}
  						{!! Form::text('query', $query, ['required',
                                'class'=>'form-control',
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<p>Copyright &copy; 2016 | <a href="{{ url('/') }}">Blog Simple</a></p>
				</div>
			</div>
		</div>
